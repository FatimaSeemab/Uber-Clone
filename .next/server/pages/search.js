    ...
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Wrapper, {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(next_link__WEBPACK_IMPORTED_MODULE_3__["default"], {
                ...
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(ConfirmButtonContainer, {
                    children: "Comfirm Locations"
                })
            })
        ]
    }));
...
h-screen
`;
const ConfirmButtonContainer = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().div)`
bg-black
...
h-12
`;
const FromToIcons = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().div)`w-10 flex flex-col mr-2 items-center`;
const InputContainer = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().div)`px-4 flex items-center bg-white mb-2 `;
const Circle = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().img)` h-2.5`;
const Line = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().img)`h-10`;
const Square = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().img)`h-3`;
const InputBoxes = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().div)`flex flex-col flex-1`;
...
`;
const PlusIcon = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().img)`h-10 w-10
rounded-full bg-gray-200  ml-3`;
const SavedPlaces = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().div)`flex items-center bg-white px-4 py-2`;
const StarIcon = (tailwind_styled_components__WEBPACK_IMPORTED_MODULE_2___default().img)`bg-gray-400 w-10 h-10 p-2 rounded-full mr-2`;
